...
namespace Utils
{
    ...
    public class RedisHelper
    {
        ...
        private IDatabase _db
        {
            get
            {
                var connMulti = GetConnectionRedisMultiplexer();
                return connMulti.GetDatabase(_dbIndex);
            }
        }

        public static IDatabase Db(int db = -1)
        {
            var connMulti = GetConnectionRedisMultiplexer();
            return connMulti.GetDatabase(db);
        }
        ...
        public static IConnectionMultiplexer GetConnectionRedisMultiplexer()
        {
            ...
            {
                throw new RedisConnectException(e.Message);
            }
        }
        ...
        static RedisHelper()
        {
            ConnectionString = Config.Ins.GetConnectionString("RedisConnection");
        }
